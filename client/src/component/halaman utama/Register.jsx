...
function Register() {
  ...
  return (
    <div>
      <form action="" style={{width : "400px", height : "400px", margin : "auto", border : "1px solid black", marginTop : "100px", padding : "20px", borderRadius : "5px"}}>
        ...
        />
            ...
            <TextField id="outlined-basic" label="Fullname" variant="outlined" style={{width : "96%"}}/>
        </Box>
